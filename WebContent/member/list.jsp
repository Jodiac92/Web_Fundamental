...
<%
	...
	*/
	...
	currentBlock = 1 => start = 1, endPage = 10;
	...
	currentBlock = 2 => start = 11, endPage = 20;
	...
	currentBlock = 3 => start = 21, endPage = 26;
	*/
	int totalRows = dao.getRows();//73개
	
	//3항영산자 = ()?가 true면 ():수행되고 false면 +();이 수행됨
				...
				<div class="card-body">
					...
					<div class="table-responsive-md">
						...
						<nav aria-label="Page navigation example">
							...
							<%if(currentBlock != 1){ %>
								<li class="page-item"><a class="page-link" href="list.jsp?page=<%=startPage-1 %>" tabindex="-1">&laquo;</a>
									<%}else{ %>
								...
								<%} %>
								<li class="page-item"><%if(currentBlock != totalBlock){ %>
								<li class="page-item">
								<a class="page-link" href="list.jsp?page=<%=endPage+1 %>" tabindex="-1">&raquo;</a>
								<%}else{ %>
								<li class="page-item disabled">

package kr.co.kic.dev1.dao; //db하고 관련됨
...
public class MemberDao {
	...
	public boolean insert(MemberDto m) {
		...
		try {
			...
			//다시말해서 이 시점에서 Connection 객체를 생성하는 것이 아니라 이미 만들어진 Connection 객체를 사용하는 것이다.
			...
			try {
				...
				//Connection 객체를 종료하는 것이 아니라 Connection Pool에 Connection 객체를 반납하는 것이다.
